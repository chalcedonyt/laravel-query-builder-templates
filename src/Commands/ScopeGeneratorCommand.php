...
class ScopeGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'query:make:scope {classname} {--parameters}';
    ...
    public function handle()
    {
        try {
            ...
            $namespace = $this->config->get('query_builder_template.namespace').'\\Scopes';
            $directory = $this->appPath($this->config->get('query_builder_template.directory')).DIRECTORY_SEPARATOR.'Scopes';
